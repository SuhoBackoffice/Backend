...
public enum ErrorCode {
	...
	NOT_MATCH_STRAIGHT_PRODUCTION_SERIAL_COUNT(HttpStatus.BAD_REQUEST, "8001", "직선레일 보고서 데이터 오류. 총 생산 완료 수량과 시리얼 개수가 맞지 않습니다."),
	...
	INVALID_STRAIGHT_SERIAL(HttpStatus.BAD_REQUEST, "8004", "잘못된 직선레일 시리얼 번호 입니다. 다시 확인해 주세요."),
	...
	INACTIVE_BRANCH_SERIAL(HttpStatus.BAD_REQUEST, "8013", "해당 분기 레일 시리얼은 비활성화 상태입니다. 다시 확인해 주세요."),
