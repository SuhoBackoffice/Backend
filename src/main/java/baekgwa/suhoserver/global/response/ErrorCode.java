...
public enum ErrorCode {
	...
	INVALID_PROJECT_STRAIGHT_REGISTER_DATA_DUPLICATION(HttpStatus.BAD_REQUEST, "5004",
	...
	ALREADY_EXIST_PROJECT_BRANCH_DATA(HttpStatus.BAD_REQUEST, "5007",
	...
	NOT_FOUND_WORK_REPORT(HttpStatus.BAD_REQUEST, "8001", "보고서를 찾을 수 없습니다."),
	NOT_MATCH_STRAIGHT_PRODUCTION_SERIAL_COUNT(HttpStatus.BAD_REQUEST, "8002", "선택한 직선레일 수량이 생산 수량과 일치하지 않습니다."),
	NOT_REGISTERED_PROJECT_STRAIGHT(HttpStatus.BAD_REQUEST, "8003", "해당 프로젝트에 없는 직선레일 입니다."),
	INVALID_STRAIGHT_SERIAL(HttpStatus.BAD_REQUEST, "8004", "선택할 수 없는 직선레일 시리얼이 포함되어 있습니다."),
	INACTIVE_STRAIGHT_SERIAL(HttpStatus.BAD_REQUEST, "8005", "비활성화된 직선레일 시리얼이 포함되어 있습니다."),
	ALREADY_PRODUCED_STRAIGHT_SERIAL(HttpStatus.BAD_REQUEST, "8006", "이미 생산 완료된 직선레일 시리얼이 포함되어 있습니다."),
	ALREADY_USED_STRAIGHT_SERIAL(HttpStatus.BAD_REQUEST, "8007", "이미 작업 보고에 사용된 직선레일 시리얼이 포함되어 있습니다."),
	NOT_REGISTERED_PROJECT_BRANCH(HttpStatus.BAD_REQUEST, "8008", "해당 프로젝트에 없는 분기레일 입니다."),
	NOT_MATCH_BRANCH_PRODUCTION_SERIAL_COUNT(HttpStatus.BAD_REQUEST, "8009", "선택한 분기레일 수량이 생산 수량과 일치하지 않습니다."),
	INVALID_BRANCH_SERIAL(HttpStatus.BAD_REQUEST, "8010", "선택할 수 없는 분기레일 시리얼이 포함되어 있습니다."),
	INACTIVE_BRANCH_SERIAL(HttpStatus.BAD_REQUEST, "8011", "비활성화된 분기레일 시리얼이 포함되어 있습니다."),
	ALREADY_PRODUCED_BRANCH_SERIAL(HttpStatus.BAD_REQUEST, "8012", "이미 생산 완료된 분기레일 시리얼이 포함되어 있습니다."),
	ALREADY_USED_BRANCH_SERIAL(HttpStatus.BAD_REQUEST, "8013", "이미 작업 보고에 사용된 분기레일 시리얼이 포함되어 있습니다."),
