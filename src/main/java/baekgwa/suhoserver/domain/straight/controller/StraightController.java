...
import baekgwa.suhoserver.domain.straight.service.StraightService;
...
public class StraightController {
	...
	private final StraightService straightService;
	...
	public BaseResponse<Void> postNewStraightType(
		...
		straightService.postNewStraightType(newStraightTypeDto);
	...
	public BaseResponse<List<StraightResponse.StraightTypeDto>> getStraightTypeList() {
		List<StraightResponse.StraightTypeDto> straightTypeDtoList = straightService.getStraightTypeList(false);
	...
	public BaseResponse<List<StraightResponse.StraightTypeDto>> getLoopStraightTypeList() {
		List<StraightResponse.StraightTypeDto> straightTypeDtoList = straightService.getStraightTypeList(true);
